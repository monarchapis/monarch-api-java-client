...
public class ModulesResourceAsyncImpl extends AbstractResource implements ModulesResourceAsync {
	public ModulesResourceAsyncImpl(String baseUrl, RestClientFactory clientFactory,
	...
	public Future<ConfigurableList> listClaimSources(Callback<ConfigurableList> callback) {
		...
		final RestAsyncClient client = newAsyncClient("GET", "/claimSources") //
				.accepts("application/json");
